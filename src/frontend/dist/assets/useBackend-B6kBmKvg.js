...
import { S as Subscribable, p as pendingThenable, a as resolveEnabled, s as shallowEqualObjects, b as resolveStaleTime, n as noop$1, e as environmentManager, i as isValidTimeout, t as timeUntilStale, c as timeoutManager, f as focusManager, d as fetchState, g as replaceData, h as notifyManager, k as hashKey, l as getDefaultState, r as reactExports, m as shouldThrowError, o as useQueryClient, q as useRouterState, j as jsxRuntimeExports, L as Link } from "./index-BB7ffKCn.js";
...
const Gamepad2 = createLucideIcon("gamepad-2", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const NAV_LINKS = [
  { to: "/", label: "Home", icon: House, ocid: "nav.home_link" },
  { to: "/game", label: "Play", icon: Gamepad2, ocid: "nav.play_link" },
  { to: "/stats", label: "Stats", icon: ChartNoAxesColumn, ocid: "nav.stats_link" }
];
function Layout({ children, bare = false }) {
  const { pathname } = useLocation();
  if (bare) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 flex flex-col", children }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-xs sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-lg px-4 h-14 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center gap-1", children: NAV_LINKS.map(({ to, label, icon: Icon2, ocid }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            className: [
              ...
              active ? "bg-primary/15 text-primary font-semibold" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
            ].join(" "),
            children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-muted/40 border-t border-border py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground font-body", children: [
      "© ",
